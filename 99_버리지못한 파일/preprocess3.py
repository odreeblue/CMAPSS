...
# regime 데이터 로드
regime = np.loadtxt("results.txt",dtype='int')
...
#
# x_columns_ = list(['regime','var1','var2','var3',
#                     'var4','var5','var6',
#                     'var7','var8','var9',
#                     'var10','var11','var12',
#                     'var13','var14','var15',
...
for i in range(0,row):
    add = np.concatenate((np.reshape(data[i,2],(1,1)),np.reshape(data[i,6:26+1],(1,-1))),axis=1)
    if data[i,0] == 0:
...
np.savetxt('regime1.txt',regime[1],delimiter='\t',newline='\n')
np.savetxt('regime2.txt',regime[2],delimiter='\t',newline='\n')
np.savetxt('regime3.txt',regime[3],delimiter='\t',newline='\n')
np.savetxt('regime4.txt',regime[4],delimiter='\t',newline='\n')
np.savetxt('regime5.txt',regime[5],delimiter='\t',newline='\n')
np.savetxt('regime6.txt',regime[6],delimiter='\t',newline='\n')
...
x_columns_ = list(['timestep','sensor1','sensor2','sensor3',
...
for i in range(1,7):
    ...
    plt.savefig('spearmanValue'+str(i)+'.png', bbox_inches='tight')
    plt.cla()
