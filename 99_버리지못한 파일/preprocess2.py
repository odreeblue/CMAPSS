...
train_FD001 = np.loadtxt("train_FD001.txt", dtype = 'float', delimiter=" ") # 사용안함
train_FD002 = np.loadtxt("train_FD002.txt", dtype = 'float', delimiter=" ")
train_FD003 = np.loadtxt("train_FD003.txt", dtype = 'float', delimiter=" ") # 사용안함
train_FD004 = np.loadtxt("train_FD004.txt", dtype = 'float', delimiter=" ") # 사용안함
